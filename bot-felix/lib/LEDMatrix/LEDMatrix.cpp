...
void setEmoji(emojiType type) {
    
    switch (type)
    {
    case (HAPPY):
        EmojiExpressions::emoji_happy();
        break;
    case (SMILE):
        EmojiExpressions::emoji_smile();
        break;
    case (ANGRY):
        EmojiExpressions::emoji_angry();
        break;
    case (CRY):
        EmojiExpressions::emoji_cry();
        break;
    case (SLEEP):
        EmojiExpressions::emoji_sleep();
        break;
    default:
